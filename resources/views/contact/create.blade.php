...
@section('content')
	...
	<div class="row content">
		<fieldset>
			<div class="col-sm-12">
				<h1>Ajouter un contac</h1>
				<hr>
			</div>
			<div class="col-sm-12 form-contact">
				{!! Form::open(['route' => 'store_contact', 'method' => 'post']) !!}
					<div class="row">
							...
							<div class="content">
								...
								<div class="row">
									<div class="col-lg-12 form-group">
										...
										<br>
										<button type="button" class="civilite btn btn-pink" data-civilite='F'>
											<i class="fa fa-female"></i> <span>Madame</span>
										</button>
										<button type="button" class="civilite btn btn-blue" data-civilite='M'>
